...
function isValidFile(filename){
    ...
    for (var i = 0, len = matchesEnd.length; i < len; i++){
        ...
        if (filenameEnding == matchesEnd[i]){
            ...
            //for (var j = 0, jlen = matchesBegin.length; j < jlen; j++){
            //    mbLength = matchesBegin[j].length;
            //    filenameBegining = filenameNorm.substr(0, mbLength);
            //    if (filenameBegining == matchesBegin[j]){
            //        isValid = true;
            //        break;
            //    }
            //}
