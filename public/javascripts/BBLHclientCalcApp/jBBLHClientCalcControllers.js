...
(function (angular, window){
    ...
    console.log("jBBLHClientCalcControllers", angular);

    var jBBLHClientCalcControllers = angular.module('jBBLHClientCalcControllers', []);
    ...
    jBBLHClientCalcControllers.controller('jBBLHClientInputCalcController', ['$scope', '$window', function($scope, $window) {
        var self = this;

        var BBLH, data, RTET, inputObject, userData;
        ...
        function startCalculactions(){
            ...
            BBLH.BBLHup.run(inputObject, $window.runCallback);
        }
        this.startCalculactions = startCalculactions;

        function initBBLH(callback){
            BBLH = require('BBLH');
        ...
        function initCharts(BBLH, data){
            if (angular.equals(previousInput, inputObject)){
                ...
                BBLH.BBLHstart.STARTPROC(inputObject, function(){
                    console.log('data', data);
    ...
    jBBLHClientCalcControllers.controller('TabController', function(){
        this.curTab = 2;
    ...
    jBBLHClientCalcControllers.filter('numberFilter', ['$filter', function ($filter) {
